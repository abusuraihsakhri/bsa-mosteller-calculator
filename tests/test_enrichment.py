"""
Automated Pytest for bsa-mosteller-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    BsamostellercalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = BsamostellercalculatorEnrichmentSuite()
