"""
FastAPI REST API Server for Bsa Mosteller Calculator.
"""
...
app = FastAPI(
    title="Bsa Mosteller Calculator API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "bsa-mosteller-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
